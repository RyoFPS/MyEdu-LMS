...
export const RadioGroupItem: React.FC<RadioGroupItemProps> = ({
  ...
  const colorMap: Record<string, string> = {
    present: isSelected
      ...
      : 'border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:border-emerald-400 hover:text-emerald-600',
    absent: isSelected
    ...
    late: isSelected
      ...
      : 'border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:border-amber-400 hover:text-amber-600',
    excused: isSelected
